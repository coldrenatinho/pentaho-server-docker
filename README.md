...
1. Enviar para o servidor o pacote "pentaho-server-docker" (pasta com dockerfile, docker-compose, lib, data)

2. Criar imagem (build) do pentaho server 9 baseado no dockerfile 
